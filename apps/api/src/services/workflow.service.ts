  ...
  public seedDefaults() {
    ...
    const defaultSteps: WorkflowStepConfig[] = [
      ...
      },
      {
        ...
        required: true,
        deadlineDays: 35,
        title: 'Monthly Mentor Milestone Review',
        description: 'Industry mentor assessment and milestone signoff',
        evaluationCriteria: 'Milestone deliverable quality and progress evaluation',
        maxMarks: 50,
      ...
      },
      {
        ...
        description: 'Comprehensive rubric-aligned final grading (/100) and milestone mastery',
